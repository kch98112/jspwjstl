...
insert into notices(seq,title,writer,content,regdate,hit) values('1','test1','kim','content1',sysdate,0);
...
insert into board(bno,bsubj,bwritter,bmemo,bdate,bcnt) values('1','math','kim','memo1',sysdate,0);
